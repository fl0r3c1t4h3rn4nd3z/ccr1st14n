        ...
        <div class="footer-top">
            <div class="footer-left">
                <!--<div class="footer-text">-->
                    <a href="#">Identifika SAS 2016            </a>
                    <p>
                         Dirección: cra 45 No 3A-124 piso 2 Barrio El Lido. Santiago De Cali Valle Del Cauca Colombia<br>
                     
                        Telefono: (2)4865482<br>
                         Email: info@identifik.com.co<br>
                    </p>
                <!--</div>-->
              <!--  <div class="footer-text">
